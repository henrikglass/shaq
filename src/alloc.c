...
static Arena frame_arena_internal_ = HGL_ARENA_INITIALIZER(FRAME_ARENA_SIZE);  // TODO figure out something better... 
Arena *g_frame_arena = &frame_arena_internal_;

static Arena longterm_arena_internal_ = HGL_ARENA_INITIALIZER(LONGTERM_ARENA_SIZE);  // TODO figure out something better... 
