...
static inline SelValue fn_deltatime_(void *args);
static inline SelValue fn_rand_(void *args);
static inline SelValue fn_sqrt_(void *args);
static inline SelValue fn_pow_(void *args);
static inline SelValue fn_exp_(void *args);
static inline SelValue fn_log_(void *args);
static inline SelValue fn_exp2_(void *args);
static inline SelValue fn_log2_(void *args);
static inline SelValue fn_sin_(void *args);
static inline SelValue fn_cos_(void *args);
static inline SelValue fn_tan_(void *args);
static inline SelValue fn_asin_(void *args);
static inline SelValue fn_acos_(void *args);
static inline SelValue fn_atan_(void *args);
static inline SelValue fn_atan2_(void *args);
static inline SelValue fn_round_(void *args);
static inline SelValue fn_floor_(void *args);
static inline SelValue fn_ceil_(void *args);
static inline SelValue fn_fract_(void *args);
static inline SelValue fn_min_(void *args);
static inline SelValue fn_max_(void *args);
static inline SelValue fn_clamp_(void *args);
static inline SelValue fn_lerp_(void *args);
static inline SelValue fn_ilerp_(void *args);
static inline SelValue fn_remap_(void *args);
static inline SelValue fn_lerpsmooth_(void *args);
static inline SelValue fn_smoothstep_(void *args);
static inline SelValue fn_radians_(void *args);
static inline SelValue fn_perlin3D_(void *args);
static inline SelValue fn_aspect_ratio_(void *args);

static inline SelValue fn_vec2_(void *args);
static inline SelValue fn_vec2_from_polar_(void *args);
static inline SelValue fn_vec2_distance_(void *args);
static inline SelValue fn_vec2_length_(void *args);
static inline SelValue fn_vec2_normalize_(void *args);
static inline SelValue fn_vec2_dot_(void *args);
static inline SelValue fn_vec2_mul_scalar_(void *args);
static inline SelValue fn_vec2_lerp_(void *args);
static inline SelValue fn_vec2_slerp_(void *args);

static inline SelValue fn_vec3_(void *args);
static inline SelValue fn_vec3_from_spherical_(void *args);
static inline SelValue fn_vec3_distance_(void *args);
static inline SelValue fn_vec3_length_(void *args);
static inline SelValue fn_vec3_normalize_(void *args);
static inline SelValue fn_vec3_dot_(void *args);
static inline SelValue fn_vec3_mul_scalar_(void *args);
static inline SelValue fn_vec3_lerp_(void *args);
static inline SelValue fn_vec3_slerp_(void *args);
static inline SelValue fn_vec3_cross_(void *args);

static inline SelValue fn_vec4_(void *args);
static inline SelValue fn_vec4_distance_(void *args);
static inline SelValue fn_vec4_length_(void *args);
static inline SelValue fn_vec4_normalize_(void *args);
static inline SelValue fn_vec4_dot_(void *args);
static inline SelValue fn_vec4_mul_scalar_(void *args);
static inline SelValue fn_vec4_lerp_(void *args);
static inline SelValue fn_vec4_xyz_(void *args);
static inline SelValue fn_rgba_(void *args);

static inline SelValue fn_ivec2_(void *args);
static inline SelValue fn_iresolution_(void *args);

static inline SelValue fn_ivec3_(void *args);

static inline SelValue fn_ivec4_(void *args);

static inline SelValue fn_mat2_(void *args);
static inline SelValue fn_mat2_id_(void *args);

static inline SelValue fn_mat3_(void *args);
static inline SelValue fn_mat3_id_(void *args);

static inline SelValue fn_mat4_(void *args);
static inline SelValue fn_mat4_id_(void *args);
static inline SelValue fn_mat4_make_scale_(void *args);
static inline SelValue fn_mat4_make_rotation_(void *args);
static inline SelValue fn_mat4_make_translation_(void *args);
static inline SelValue fn_mat4_look_at_(void *args);
static inline SelValue fn_mat4_scale_(void *args);
static inline SelValue fn_mat4_rotate_(void *args);
static inline SelValue fn_mat4_translate_(void *args);
static inline SelValue fn_mat4_mul_mat4_(void *args);
...
const Func BUILTIN_FUNCTIONS[] = 
{
    ...
    { .id = HGL_SV_LIT("deltatime"),    .type = TYPE_FLOAT, .qualifier = QUALIFIER_NONE, .impl = fn_deltatime_,    .argtypes = {TYPE_NIL},                                                             .synopsis = "float deltatime()", .desc = "Returns the frame delta time in seconds.", },
    { .id = HGL_SV_LIT("rand"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_NONE, .impl = fn_rand_,         .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},                                     .synopsis = "float rand(float min, float max)", .desc = "Returns a random number in [`min`, `max`].", },
    { .id = HGL_SV_LIT("sqrt"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_sqrt_,         .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float sqrt(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("pow"),          .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_pow_,          .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},                                     .synopsis = "float pow(float x, float y)", .desc = NULL, },
    { .id = HGL_SV_LIT("exp"),          .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_exp_,          .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float exp(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("log"),          .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_log_,          .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float log(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("exp2"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_exp2_,         .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float exp2(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("log2"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_log2_,         .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float log2(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("sin"),          .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_sin_,          .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float sin(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("cos"),          .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_cos_,          .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float cos(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("tan"),          .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_tan_,          .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float tan(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("asin"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_asin_,         .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float asin(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("acos"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_acos_,         .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float acos(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("atan"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_atan_,         .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float atan(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("atan2"),        .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_atan2_,        .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},                                     .synopsis = "float atan2(float y, float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("round"),        .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_round_,        .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float round(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("floor"),        .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_floor_,        .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float floor(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("ceil"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_ceil_,         .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float ceil(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("fract"),        .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_fract_,        .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float fract(float x)", .desc = NULL, },
    { .id = HGL_SV_LIT("min"),          .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_min_,          .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},                                     .synopsis = "float min(float a, float b)", .desc = NULL, },
    { .id = HGL_SV_LIT("max"),          .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_max_,          .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},                                     .synopsis = "float max(float a, float b)", .desc = NULL, },
    { .id = HGL_SV_LIT("clamp"),        .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_clamp_,        .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},                         .synopsis = "float clamp(float min, float max, float x)", .desc = "Returns x clamped to [`min`,`max`]", },
    { .id = HGL_SV_LIT("lerp"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_lerp_,         .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},                         .synopsis = "float lerp(float a, float b, float t)", .desc = "Linear interpolation", },
    { .id = HGL_SV_LIT("ilerp"),        .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_ilerp_,        .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},                         .synopsis = "float ilerp(float a, float b, float x)", .desc = "Inverse linear interpolation", },
    { .id = HGL_SV_LIT("remap"),        .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_remap_,        .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL}, .synopsis = "float remap(float in_min, float in_max, float out_min, float out_max, float x)", .desc = "See Freya Holmér's talks :-)", },
    { .id = HGL_SV_LIT("lerpsmooth"),   .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_lerpsmooth_,   .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},             .synopsis = "float lerpsmooth(float a, float b, float dt, float omega)", .desc = "See Freya Holmér's talks :-)" , },
    { .id = HGL_SV_LIT("smoothstep"),   .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_smoothstep_,   .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float smoothstep(float t)", .desc = "Steps, smoothly. :3", },
    { .id = HGL_SV_LIT("radians"),      .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_radians_,      .argtypes = {TYPE_FLOAT, TYPE_NIL},                                                 .synopsis = "float radians(float degrees)", .desc = "Converts degrees into radians", },
    { .id = HGL_SV_LIT("perlin3D"),     .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_perlin3D_,     .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},                         .synopsis = "float perlin3D(float x, float y, float z)", .desc = "Perlin noise at (x,y,z)", },
    { .id = HGL_SV_LIT("aspect_ratio"), .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_aspect_ratio_, .argtypes = {TYPE_NIL},                                                             .synopsis = "float aspect_ratio()", .desc = "Returns the current window aspect ratio (width/height)", },

    { .id = HGL_SV_LIT("vec2"),            .type = TYPE_VEC2,  .qualifier = QUALIFIER_PURE, .impl = fn_vec2_,            .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},           .synopsis = "vec2 vec2(float x, float y)", .desc = NULL, },
    { .id = HGL_SV_LIT("vec2_from_polar"), .type = TYPE_VEC2,  .qualifier = QUALIFIER_PURE, .impl = fn_vec2_from_polar_, .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL},           .synopsis = "vec2 vec2_from_polar(float r, float phi)", .desc = NULL, },
    { .id = HGL_SV_LIT("vec2_distance"),   .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_vec2_distance_,   .argtypes = {TYPE_VEC2, TYPE_VEC2, TYPE_NIL},             .synopsis = "vec2 vec2_distance(vec2 a, vec2 b)", .desc = NULL, },
    { .id = HGL_SV_LIT("vec2_length"),     .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_vec2_length_,     .argtypes = {TYPE_VEC2, TYPE_NIL},                        .synopsis = "vec2 vec2_length(vec2 v)", .desc = NULL, },
    { .id = HGL_SV_LIT("vec2_normalize"),  .type = TYPE_VEC2,  .qualifier = QUALIFIER_PURE, .impl = fn_vec2_normalize_,  .argtypes = {TYPE_VEC2, TYPE_NIL},                        .synopsis = "vec2 vec2_normalize(vec2 v)", .desc = NULL, },
    { .id = HGL_SV_LIT("vec2_dot"),        .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_vec2_dot_,        .argtypes = {TYPE_VEC2, TYPE_VEC2, TYPE_NIL},             .synopsis = "vec2 vec2_dot(vec2 a, vec2 b)", .desc = NULL, },
    { .id = HGL_SV_LIT("vec2_mul_scalar"), .type = TYPE_VEC2,  .qualifier = QUALIFIER_PURE, .impl = fn_vec2_mul_scalar_, .argtypes = {TYPE_VEC2, TYPE_FLOAT, TYPE_NIL},            .synopsis = "vec2 vec2_mul_scalar(vec2 v, float s)", .desc = NULL, },
    { .id = HGL_SV_LIT("vec2_lerp"),       .type = TYPE_VEC2,  .qualifier = QUALIFIER_PURE, .impl = fn_vec2_lerp_,       .argtypes = {TYPE_VEC2, TYPE_VEC2, TYPE_FLOAT, TYPE_NIL}, .synopsis = "vec2 vec2_lerp(vec2 a, vec2 b, float t)", .desc = NULL, },
    { .id = HGL_SV_LIT("vec2_slerp"),      .type = TYPE_VEC2,  .qualifier = QUALIFIER_PURE, .impl = fn_vec2_slerp_,      .argtypes = {TYPE_VEC2, TYPE_VEC2, TYPE_FLOAT, TYPE_NIL}, .synopsis = "vec2 vec2_slerp(vec2 a, vec2 b, float t)", .desc = NULL, },

    { .id = HGL_SV_LIT("vec3"),                .type = TYPE_VEC3,  .qualifier = QUALIFIER_PURE, .impl = fn_vec3_,                .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL}, .synopsis = "vec3 vec3(float x, float y, float z)",                      . desc = NULL, },
    { .id = HGL_SV_LIT("vec2_from_spherical"), .type = TYPE_VEC3,  .qualifier = QUALIFIER_PURE, .impl = fn_vec3_from_spherical_, .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL}, .synopsis = "vec3 vec3_from_spherical(float r, float phi, float theta)", . desc = NULL, },
    { .id = HGL_SV_LIT("vec3_distance"),       .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_vec3_distance_,       .argtypes = {TYPE_VEC3, TYPE_VEC3, TYPE_NIL},               .synopsis = "vec3 vec3_distance(vec3 a, vec3 b)",                        . desc = NULL, },
    { .id = HGL_SV_LIT("vec3_length"),         .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_vec3_length_,         .argtypes = {TYPE_VEC3, TYPE_NIL},                          .synopsis = "vec3 vec3_length(vec3 v)",                                  . desc = NULL, },
    { .id = HGL_SV_LIT("vec3_normalize"),      .type = TYPE_VEC3,  .qualifier = QUALIFIER_PURE, .impl = fn_vec3_normalize_,      .argtypes = {TYPE_VEC3, TYPE_NIL},                          .synopsis = "vec3 vec3_normalize(vec3 v)",                               . desc = NULL, },
    { .id = HGL_SV_LIT("vec3_dot"),            .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_vec3_dot_,            .argtypes = {TYPE_VEC3, TYPE_VEC3, TYPE_NIL},               .synopsis = "vec3 vec3_dot(vec3 a, vec3 b)",                             . desc = NULL, },
    { .id = HGL_SV_LIT("vec3_mul_scalar"),     .type = TYPE_VEC3,  .qualifier = QUALIFIER_PURE, .impl = fn_vec3_mul_scalar_,     .argtypes = {TYPE_VEC3, TYPE_FLOAT, TYPE_NIL},              .synopsis = "vec3 vec3_mul_scalar(vec3 v, float s)",                     . desc = NULL, },
    { .id = HGL_SV_LIT("vec3_lerp"),           .type = TYPE_VEC3,  .qualifier = QUALIFIER_PURE, .impl = fn_vec3_lerp_,           .argtypes = {TYPE_VEC3, TYPE_VEC3, TYPE_FLOAT, TYPE_NIL},   .synopsis = "vec3 vec3_lerp(vec3 a, vec3 b, float t)",                   . desc = NULL, },
    { .id = HGL_SV_LIT("vec3_slerp"),          .type = TYPE_VEC3,  .qualifier = QUALIFIER_PURE, .impl = fn_vec3_slerp_,          .argtypes = {TYPE_VEC3, TYPE_VEC3, TYPE_FLOAT, TYPE_NIL},   .synopsis = "vec3 vec3_slerp(vec3 a, vec3 b, float t)",                  . desc = NULL, },
    { .id = HGL_SV_LIT("vec3_cross"),          .type = TYPE_VEC3,  .qualifier = QUALIFIER_PURE, .impl = fn_vec3_cross_,          .argtypes = {TYPE_VEC3, TYPE_VEC3, TYPE_NIL},               .synopsis = "vec3 vec3_slerp(vec3 a, vec3 b, float t)",                  . desc = NULL, },

    { .id = HGL_SV_LIT("vec4"),            .type = TYPE_VEC4,  .qualifier = QUALIFIER_PURE, .impl = fn_vec4_,            .argtypes = {TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_FLOAT, TYPE_NIL}, .synopsis = "vec4 vec4(float x, float y, float z, float w)", .desc = NULL, },
    { .id = HGL_SV_LIT("vec4_distance"),   .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_vec4_distance_,   .argtypes = {TYPE_VEC4, TYPE_VEC4, TYPE_NIL},                           .synopsis = "vec4 vec4_distance(vec4 a, vec4 b)",            .desc = NULL, },
    { .id = HGL_SV_LIT("vec4_length"),     .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_vec4_length_,     .argtypes = {TYPE_VEC4, TYPE_NIL},                                      .synopsis = "vec4 vec4_length(vec4 v)",                      .desc = NULL, },
    { .id = HGL_SV_LIT("vec4_normalize"),  .type = TYPE_VEC4,  .qualifier = QUALIFIER_PURE, .impl = fn_vec4_normalize_,  .argtypes = {TYPE_VEC4, TYPE_NIL},                                      .synopsis = "vec4 vec4_normalize(vec4 v)",                   .desc = NULL, },
    { .id = HGL_SV_LIT("vec4_dot"),        .type = TYPE_FLOAT, .qualifier = QUALIFIER_PURE, .impl = fn_vec4_dot_,        .argtypes = {TYPE_VEC4, TYPE_VEC4, TYPE_NIL},                           .synopsis = "vec4 vec4_dot(vec4 a, vec4 b)",                 .desc = NULL, },
    { .id = HGL_SV_LIT("vec4_mul_scalar"), .type = TYPE_VEC4,  .qualifier = QUALIFIER_PURE, .impl = fn_vec4_mul_scalar_, .argtypes = {TYPE_VEC4, TYPE_FLOAT, TYPE_NIL},                          .synopsis = "vec4 vec4_mul_scalar(vec4 v, float s)",         .desc = NULL, },
    { .id = HGL_SV_LIT("vec4_lerp"),       .type = TYPE_VEC4,  .qualifier = QUALIFIER_PURE, .impl = fn_vec4_lerp_,       .argtypes = {TYPE_VEC4, TYPE_VEC4, TYPE_FLOAT, TYPE_NIL},               .synopsis = "vec4 vec4_lerp(vec4 a, vec4 b, float t)",       .desc = NULL, },
    { .id = HGL_SV_LIT("vec4_xyz"),        .type = TYPE_VEC3,  .qualifier = QUALIFIER_PURE, .impl = fn_vec4_xyz_,        .argtypes = {TYPE_VEC4, TYPE_NIL},                                      .synopsis = "vec3 vec3_xyz(vec4 v)",                         .desc = "Returns the x,y, and z components of `v` as a vec3", },
    { .id = HGL_SV_LIT("rgba"),            .type = TYPE_VEC4,  .qualifier = QUALIFIER_PURE, .impl = fn_rgba_,            .argtypes = {TYPE_INT, TYPE_NIL},                                       .synopsis = "vec4 rgba(int hexcode)",                        .desc = "Returns a vector with R, G, B, and A components normalized to 0.0 - 1.0 given a color hexcode", },

    { .id = HGL_SV_LIT("ivec2"),        .type = TYPE_IVEC2, .qualifier = QUALIFIER_PURE, .impl = fn_ivec2_,            .argtypes = {TYPE_INT, TYPE_INT, TYPE_NIL},                                         .synopsis = "ivec2 ivec2(int x, int y)", .desc = NULL, },
    { .id = HGL_SV_LIT("iresolution"),  .type = TYPE_IVEC2, .qualifier = QUALIFIER_PURE, .impl = fn_iresolution_,      .argtypes = {TYPE_NIL},                                         .synopsis = "ivec2 iresolution()", .desc = "Returns the current window resolution", },

    { .id = HGL_SV_LIT("ivec3"),      .type = TYPE_IVEC3, .qualifier = QUALIFIER_PURE, .impl = fn_ivec3_,      .argtypes = {TYPE_INT, TYPE_INT, TYPE_INT, TYPE_NIL},                               .synopsis = "ivec3 ivec3(int x, int y, int z)", .desc = NULL, },

    { .id = HGL_SV_LIT("ivec4"),      .type = TYPE_IVEC4, .qualifier = QUALIFIER_PURE, .impl = fn_ivec4_,      .argtypes = {TYPE_INT, TYPE_INT, TYPE_INT, TYPE_INT, TYPE_NIL},                     .synopsis = "ivec4 ivec4(int x, int y, int z, int w)", .desc = NULL, },

    { .id = HGL_SV_LIT("mat2"),       .type = TYPE_MAT2,  .qualifier = QUALIFIER_PURE, .impl = fn_mat2_,       .argtypes = {TYPE_VEC2, TYPE_VEC2, TYPE_NIL},                                       .synopsis = "mat2 mat2(vec2 c0, vec2 c1)", .desc = NULL, },
    { .id = HGL_SV_LIT("mat2_id"),    .type = TYPE_MAT2,  .qualifier = QUALIFIER_PURE, .impl = fn_mat2_id_,    .argtypes = {TYPE_NIL},                                                             .synopsis = "mat2 mat2_id()", .desc = NULL, },

    { .id = HGL_SV_LIT("mat3"),       .type = TYPE_MAT3,  .qualifier = QUALIFIER_PURE, .impl = fn_mat3_,       .argtypes = {TYPE_VEC3, TYPE_VEC3, TYPE_VEC3, TYPE_NIL},                            .synopsis = "mat3 mat3(vec3 c0, vec3 c1, vec3 c2)", .desc = NULL, },
    { .id = HGL_SV_LIT("mat3_id"),    .type = TYPE_MAT3,  .qualifier = QUALIFIER_PURE, .impl = fn_mat3_id_,    .argtypes = {TYPE_NIL},                                                             .synopsis = "mat3 mat3_id()", .desc = NULL, },

    { .id = HGL_SV_LIT("mat4"),                  .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_,                  .argtypes = {TYPE_VEC4, TYPE_VEC4, TYPE_VEC4, TYPE_VEC4, TYPE_NIL}, .synopsis = "mat4 mat4(vec4 c0, vec4 c1, vec4 c2, vec4 c3)",        .desc = NULL, },
    { .id = HGL_SV_LIT("mat4_id"),               .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_id_,               .argtypes = {TYPE_NIL},                                             .synopsis = "mat4 mat4_id()",                                       .desc = NULL, },
    { .id = HGL_SV_LIT("mat4_make_scale"),       .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_make_scale_,       .argtypes = {TYPE_VEC3, TYPE_NIL},                                  .synopsis = "mat4 mat4_make_scale(vec3 v)",                         .desc = NULL, },
    { .id = HGL_SV_LIT("mat4_make_rotation"),    .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_make_rotation_,    .argtypes = {TYPE_FLOAT, TYPE_VEC3, TYPE_NIL},                      .synopsis = "mat4 mat4_make_rotation(float angle, vec3 axis)",      .desc = NULL, },
    { .id = HGL_SV_LIT("mat4_make_translation"), .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_make_translation_, .argtypes = {TYPE_VEC3, TYPE_NIL},                                  .synopsis = "mat4 mat4_make_translation(vec3 v)",                   .desc = NULL, },
    { .id = HGL_SV_LIT("mat4_look_at"),          .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_look_at_,          .argtypes = {TYPE_VEC3, TYPE_VEC3, TYPE_VEC3, TYPE_NIL},            .synopsis = "mat4 mat4_look_at(vec3 camera, vec3 target, vec3 up)", .desc = NULL, },
    { .id = HGL_SV_LIT("mat4_scale"),            .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_scale_,            .argtypes = {TYPE_MAT4, TYPE_VEC3, TYPE_NIL},                       .synopsis = "mat4 mat4_scale(mat4 m, vec3 v)",                      .desc = NULL, },
    { .id = HGL_SV_LIT("mat4_rotate"),           .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_rotate_,           .argtypes = {TYPE_MAT4, TYPE_FLOAT, TYPE_VEC3, TYPE_NIL},           .synopsis = "mat4 mat4_rotate(mat4 m, float angle, vec3 axis)",     .desc = NULL, },
    { .id = HGL_SV_LIT("mat4_translate"),        .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_translate_,        .argtypes = {TYPE_MAT4, TYPE_VEC3, TYPE_NIL},                       .synopsis = "mat4 mat4_translate(mat4 m, vec3 v)",                  .desc = NULL, },
    { .id = HGL_SV_LIT("mat4_mul_mat4"),         .type = TYPE_MAT4, .qualifier = QUALIFIER_PURE, .impl = fn_mat4_mul_mat4_,         .argtypes = {TYPE_MAT4, TYPE_MAT4, TYPE_NIL},                       .synopsis = "mat4 mat4_mul_mat4(mat4 lhs, mat4 rhs)",               .desc = NULL, },
