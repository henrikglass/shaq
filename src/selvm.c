...
const Func BUILTIN_FUNCTIONS[] = 
{
    ...
    { .id = HGL_SV_LIT("iresolution"),  .type = TYPE_IVEC2, .qualifier = QUALIFIER_NONE, .impl = fn_iresolution_,      .argtypes = {TYPE_NIL},                                         .synopsis = "ivec2 iresolution()", .desc = "Returns the current window resolution", },
